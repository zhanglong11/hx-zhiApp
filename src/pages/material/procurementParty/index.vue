<template>
  <view class="main">
    ...
    <!-- 筛选组件 start -->
    <uni-drawer-filter ref="filterRef" type="materialProcurementParty" @submit="screenCallback"></uni-drawer-filter>
    <!-- 筛选组件 end -->
  </view>
</template>
...
export default {
  ...
  methods: {
    ...
    async handleSafeDetailView(id) {
      this.$utils.toUrl(`/pages/material/procurementParty/detail?id=${id}`)
    },
