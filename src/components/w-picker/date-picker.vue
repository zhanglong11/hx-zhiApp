  ...
  methods: {
    ...
    resetData(year, month, day, hour, minute) {
      ...
      let minutesLen = disabledAfter
        ? year * 1 < curYear || month * 1 < curMonth || day * 1 < curDay || hour * 1 < curHour
          ? 60
          : curMinute + 1
        : 60
      let secondsLen = disabledAfter
        ? year * 1 < curYear || month * 1 < curMonth || day * 1 < curDay || hour * 1 < curHour || minute * 1 < curMinute
          ? 60
          : curSecond + 1
        : 60
    ...
    getData(dVal) {
      ...
      let minutesLen = disabledAfter
        ...
        : 60
      let secondsLen = disabledAfter
        ? year < curYear || month < curMonth || day < curDay || hour < curHour || minute < curMinute
          ? 60
          : curSecond + 1
        : 60
      ...
      switch (this.fields) {
        ...
        case 'month':
          pickVal = disabledAfter
            ...
            : curFlag
            ? [years.indexOf(curYear + ''), months.indexOf(this.formatNum(curMonth))]
            : [
                dVal[0] && years.indexOf(dVal[0]) != -1 ? years.indexOf(dVal[0]) : 0,
                dVal[1] && months.indexOf(dVal[1]) != -1 ? months.indexOf(dVal[1]) : 0
              ]
